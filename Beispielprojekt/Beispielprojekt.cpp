...
public:
		...
		: Window(Spielfeld_x, Spielfeld_y)
	{
		...
		spieler_1.act_Postion_X = block_x;
		spieler_1.act_Postion_Y = block_y;
	...
	void draw() override
	{
		...
		graphics().draw_rect(double(spieler_1.act_Postion_X), double(spieler_1.act_Postion_Y), double(block_x), double(block_y), Gosu::Color::WHITE, 0);
